...
![Fisherman Portrait](./stable-diffusion/assets/output-1.png)
...
![Tokyo Rain](./stable-diffusion/assets/output-2.png)
...
![Modern Living Room](./stable-diffusion/assets/output-3.png)
